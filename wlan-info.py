...
cmd_ch = subprocess.Popen(['sudo iwlist wlp4s0 frequency |  grep Current | awk \'{print substr($5,0,3)}\''], stdout=subprocess.PIPE, stderr=subprocess.STDOUT, shell=True)
...
print(rssi + " dBm, Ch " + ch + ", HT" + ht + " @ " + ap.upper())
